 ...
 * prakashs@uab.edu
 */
public class StopSensorValuesRequest extends Message {
    public static final short LEN = Header.LEN;
    public static final byte MSG_TYPE = 0x70;

    public StopSensorValuesRequest(byte[] msg) {
        super(msg);
        if (msg.length != LEN) {
    ...
    public StopSensorValuesRequest() {
